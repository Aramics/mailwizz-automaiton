 ...
 * 
 */
class AutomationExtBlockGroupLogic extends AutomationExtBlockGroupAction
{
    ...
    public function run(AutomationExtBlock $block, ListSubscriber $subscriber = null)
    {
        ...
        $yesNoBlock = $blockType == AutomationExtBlockTypes::NO || $blockType == AutomationExtBlockTypes::YES;
        ...
        if (!$subscriber && $parentType != AutomationExtBlockTypes::SPECIFIC_DATE) {
        ...
        $blockExpectedValue = $blockType == AutomationExtBlockTypes::YES ? true : false;
